window.HarnessI18n = {
  "en": {
    ...
    "collapseDocumentNav": "Hide documents",
    "expandDocumentNav": "Show documents",
    "collapseSidePanel": "Hide side",
    "expandSidePanel": "Show side",
    ...
    "queueConfirmedFinalizedDesc": "Tasks with Git-backed human review confirmation; archive tombstones stay in the archive history queue.",
  ...
  "zh": {
    ...
    "sourceDocuments": "源文档",
    "taskDocuments": "任务文档",
    "collapseDocumentNav": "收起文档",
    "expandDocumentNav": "展开文档",
    "collapseSidePanel": "收起侧栏",
    "expandSidePanel": "展开侧栏",
    ...
    "queueConfirmedFinalizedDesc": "已有 Git 可追责人工审查确认的任务；归档 tombstone 留在历史归档队列。",
