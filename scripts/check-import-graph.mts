...
export const architectureImportContract: ArchitectureImportContract = {
  ...
  phaseOpenExceptions: [
    ...
    {
      id: "P08-workbench-review-subject-source-adapter",
      source: "scripts/adapters/workbench/workbench-review-subject-source.mts",
      target: "scripts/lib/task-repository.mts",
      ownerPhase: "P08-dashboard-workbench-consumer-cutover",
      expiryPhase: "P13-final-no-fallback-audit",
      reason: "Workbench review subject scanner materialization is isolated behind the explicit source Adapter while dashboard-workbench consumes only the WorkbenchReviewSubjectSource contract.",
      evidence: "import graph check plus P08 workbench no-data-loss fixtures",
    },
    {
      id: "P08-workbench-review-confirmation-runner-governance-adapter",
      source: "scripts/adapters/workbench/review-confirmation-runner.mts",
      target: "scripts/lib/governance-sync.mts",
      ownerPhase: "P08-dashboard-workbench-consumer-cutover",
      expiryPhase: "P13-final-no-fallback-audit",
      reason: "Workbench review-confirmation git sync is isolated behind an explicit write Adapter while application workbench code keeps only pure queue policy.",
      evidence: "import graph check plus P08 workbench no-data-loss fixtures",
    },
    {
      id: "P08-workbench-review-confirmation-runner-lifecycle-adapter",
      source: "scripts/adapters/workbench/review-confirmation-runner.mts",
      target: "scripts/lib/task-lifecycle.mts",
      ownerPhase: "P08-dashboard-workbench-consumer-cutover",
      expiryPhase: "P13-final-no-fallback-audit",
      reason: "Workbench review-confirmation lifecycle writes are isolated behind an explicit write Adapter while application workbench code keeps only pure queue policy.",
      evidence: "import graph check plus P08 workbench no-data-loss fixtures",
    },
    {
      id: "P08-workbench-lesson-sedimentation-runner-adapter",
      source: "scripts/adapters/workbench/lesson-sedimentation-runner.mts",
      target: "scripts/lib/task-lesson-sedimentation.mts",
      ownerPhase: "P08-dashboard-workbench-consumer-cutover",
      expiryPhase: "P13-final-no-fallback-audit",
      reason: "Workbench aggregate lesson-sedimentation writes are isolated behind an explicit write Adapter while dashboard-workbench consumes the adapter command.",
