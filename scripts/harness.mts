...
Usage:
  ...
  harness preset run <id> <plan|scaffold|check> --task <task-id> [--use-current-preset --reason text] [--json] [target]
  harness preset action <id> <action> --task <task-id> [--allow-scripts] [--use-current-preset --reason text] [--json] [action flags...] [target]
  ...
  harness task-supersede <old-task-id> --by <new-task-id> [--reason text] [--deleted-by name-or-email] [--confirm task-id] [--allow-open-findings] [target]
  harness task-delete <task-id> [--soft|--hard] [--confirm canonical-id] [--deleted-by name-or-email] [--reason text] [target]
